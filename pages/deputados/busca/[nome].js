...
export async function getServerSideProps(context) {
    ...
    const resultDeputado = await apiDeputados.get(`/deputados/?dataInicio=2022-01-01&nome=${name}&ordem=ASC&ordenarPor=nome`)
...
/* Mano, outra coisa, tem como eu descobrir oq pode tá demorando pra carregar a página? */